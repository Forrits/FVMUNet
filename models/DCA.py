...
# https://arxiv.org/pdf/2303.17696.pdf
# Dual Cross-Attention for Medical Image Segmentation, Engineering Applications of Artificial Intelligence
...
class DCA(nn.Module):
    def __init__(self,
                 ...
                 spatial_att=True,
                 n=1,
                 channel_head=[1, 1, 1, 1,1],
                 spatial_head=[4, 4, 4, 4,4],
                 ):
        super().__init__()
        self.n = n
...
if __name__ == '__main__':
    ...
    input1 = torch.randn(8, features[0], 128, 128)
    input2 = torch.randn(8, features[1], 64, 64)
    input3 = torch.randn(8, features[2], 32, 32)
    input4 = torch.randn(8, features[3], 16, 16)
    input5 = torch.randn(8, features[4], 8, 8)
    ...
    output1, output2, output3, output4, output5= dca_model((input1, input2, input3, input4,input5))
